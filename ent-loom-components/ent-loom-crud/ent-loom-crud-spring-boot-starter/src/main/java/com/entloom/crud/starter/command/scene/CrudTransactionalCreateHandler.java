...
import com.entloom.crud.core.capability.command.scene.AbstractEntityCreateHandler;
...
/**
 * Spring 环境下带默认事务边界的实体 CREATE 场景模板。
 *
 * @param <T> 实体类型
 * @param <R> 业务返回类型
 */
public abstract class CrudTransactionalCreateHandler<T, R>
    extends AbstractEntityCreateHandler<T, R> {
