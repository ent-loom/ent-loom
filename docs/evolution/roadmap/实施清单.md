...
> 当前小项：M4，守卫与回归
> 阻塞项：无
> 验收证据：C1-C7、M1、M2、M3 已完成。M3：CRUD Built-in / Project Convention、Native-only 与 Meta-enabled 统一裁决、创建时间字段 `writable=false` 投影、Adapter 纯投影和消费者不支持属性 WARN 已落地；JDK 21 下 CRUD Core 199 项、Meta CRUD Adapter 15 项、Meta Starter 8 项通过，`CrudConventionConsumerTest` 已覆盖消费者行为。当前进入 M4。
