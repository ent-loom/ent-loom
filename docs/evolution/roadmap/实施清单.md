...
> 状态：In Progress
> 最近核验：2026-08-21
> 当前大项：C4，确认 `ent-loom-crud-core` 的模块边界
> 当前小项：C4，确认 `ent-loom-crud-core` 的模块边界
> 阻塞项：无
> 验收证据：C1、C2、C3 已完成。C3：`com.entloom.crud.spring.config` 已迁移并删除，Starter 配置入口统一到 `com.entloom.crud.starter.*`；JDK 21 clean 回归 Core 197、JDBC 44、Starter 83 项通过。当前进入 C4。
