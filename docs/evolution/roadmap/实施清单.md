...
> 状态：In Progress
> 最近核验：2026-08-21
> 当前大项：M1，公共 Contribution 与属性级 Resolver
> 当前小项：M1，公共 Contribution 与属性级 Resolver
> 阻塞项：无
> 验收证据：C1-C7 已完成。C7：任务快照显式保存主体、已授予 scope、最终治理 scope 和 requestId/traceId，本地任务持久化往返与线程池隔离回归通过；JDK 21 下 CRUD Core 199 项通过。当前进入 M1。
