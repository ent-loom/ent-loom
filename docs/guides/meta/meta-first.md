...
架构边界见 [Meta 分层与运行模型](../../architecture/core/meta/layering-summary.md)，属性裁决规则见
[元数据约定与裁决契约](../../architecture/core/metadata-resolution-contract.md)。
...
[Meta Runtime Adapters](../../architecture/core/meta/runtime-adapters.md) 为准。
