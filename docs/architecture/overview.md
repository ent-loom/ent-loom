...
建模主链以 [元数据约定与裁决契约](core/metadata-resolution-contract.md) 为权威来源；执行主链以 [治理 Pipeline](core/governance/pipeline.md) 和各组件架构为权威来源。两者通过组件 Runtime Model 连接，但不合并成一个万能模型。
