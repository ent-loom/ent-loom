...
顶层 Contract 可以处于 `Target` 状态，但组件架构只能描述已经存在的能力。Project Convention、DDL 静态 Adapter 和对应 Starter 收集机制已形成当前闭环；UI Adapter 与兼容线迁移等尚未完成事项统一在 [演进路线图](../evolution/roadmap/index.md) 跟踪。
