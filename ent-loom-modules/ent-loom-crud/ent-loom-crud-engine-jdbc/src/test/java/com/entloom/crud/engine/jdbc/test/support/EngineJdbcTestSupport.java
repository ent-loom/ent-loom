...
public abstract class EngineJdbcTestSupport {
    ...
    void setUpEngineFixture() {
        ...
        jdbcTemplate.execute("drop table if exists t_repository_order");
        ...
        jdbcTemplate.execute("create table t_repository_order(id bigint generated by default as identity primary key, order_no varchar(64) unique, priority int not null default 0, is_deleted int not null default 0)");

        this.metaRegistry = new CrudRuntimeModelBackedEntityMetaRegistry(
            new CrudNativeRuntimeModelParser()
                .parse(Arrays.<Class<?>>asList(OrderTestEntity.class, OrderItemTestEntity.class, RepositoryOrderTestEntity.class))
        );
